...
void PrintDecodedMachineInstruction(InstructionFields* instructionFieldsPtr);
...
void PrintDecodedMachineInstruction(InstructionFields* instructionFieldsPtr)
{
    ...
    if (assemblyMnemonic == B)
    {
        ...
        printf("Immediate Value:   Hex: 0x%hX       ", instructionFieldsPtr->immediate);
        printf("Binary: ");
        printf(TWELVE_BIT_BYTE_TO_BINARY_PATTERN, TWELVE_BIT_BYTE_TO_BINARY(instructionFieldsPtr->immediate));
        printf("\n");
